...
" 设置忽略的文件
let NERDTreeIgnore=['\.vim$', '\~$', '\.o$', '\.d$', '\.a$', '\.out$', '\.tgz$', '\.zip$', '\.7z$']
...
autocmd filetype c nnoremap <F1> :w <bar> exec '!gcc --std=c11 -pthread '.shellescape('%').' -o ./bin/'.shellescape('%:r').' && ./bin/'.shellescape('%:r')<CR>
...
autocmd BufNewFile *.cc,*.cpp,*.hpp,*.[ch],*.sh,*.java,*.go exec ":call SetTitle()"
...
" 添加自动补全字典
au FileType c setlocal dict+=~/.vim/dictionary/vim-dict/dict/c.dict
au FileType cpp setlocal dict+=~/.vim/dictionary/cpp_keywords_list.txt
au FileType python setlocal dict+=~/.vim/dictionary/vim-dict/dict/python.dict
au FileType sh setlocal dict+=~/.vim/dictionary/vim-dict/dict/sh.dict
au FileType make setlocal dict+=~/.vim/dictionary/vim-dict/dict/make.dict
au FileType cmake setlocal dict+=~/.vim/dictionary/vim-dict/dict/cmake.dict
au FileType rust setlocal dict+=~/.vim/dictionary/vim-dict/dict/rust.dict
au FileType vim setlocal dict+=~/.vim/dictionary/vim-dict/dict/vim.dict
au FileType lua setlocal dict+=~/.vim/dictionary/vim-dict/dict/lua.dict
